/**
 * SSI Screener component.
 * Combines form input with eligibility evaluation and results display.
 */
...
import { ssiFormSchema } from '../../lib/screener/ssi-form-schema';
import {
...
export function SsiScreener({
  ...
  // Clear results when user modifies the form (clears highlighting)
